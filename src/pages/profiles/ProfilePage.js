          ...
          <Row className="justify-content-between no-gutters">
            <Col xs={3} className="my-2">
              ...
              {profilePosts.results.length === 1 ? (
                <div className={styles.CountText}>homeShot</div>
              ) : (
                <div className={styles.CountText}>homeShots</div>
              )}
            </Col>
            <Col xs={3} className="my-2">
  ...
  const mainProfilePosts = (
    <>
      ...
      {profilePosts.results.length ? (
        ...
        <Asset
          src={NoResults}
          message={`No results found, ${profile?.owner} hasn't added any homeShots n yet.`}
        />
      )}
    </>
  );
